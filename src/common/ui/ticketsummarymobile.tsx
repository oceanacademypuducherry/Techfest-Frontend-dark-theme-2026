...
const TicketSummaryMobile: React.FC<TicketSummaryMobileProps> = ({
  ...
  >
    <RiCloseCircleLine className="text-4xl text-black" />
  </button>
)}
      ...
      <div>
        <div className="flex justify-between items-center mb-6  pb-4">
          <h2 className="text-gray-800 text-[16px] font-bold">Ticket Summary</h2>
          <button
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            <tr className="font-bold border-t border-gray-200 text-[14px]">
              <td className="pt-6 font-medium text-gray-800">Early Bird (Student)</td>
              <td className="pt-6 font-medium text-center">{studentCount}</td>
              <td className="pt-6 font-medium text-right">₹{studentCount * studentPrice}</td>
            </tr>
            <tr className="text-[14px]">
              <td className="pt-3 font-medium text-gray-800">Early Bird (Professional)</td>
              <td className="pt-3 font-medium text-center">{professionalCount}</td>
              <td className="pt-3 font-medium text-right">₹{professionalCount * professionalPrice}</td>
            </tr>
          </tbody>
          <tfoot>
            <tr className="text-[14px]">
              <td className="pt-3 pb-8 font-medium text-gray-800">10% Discount</td>
              <td className="pt-3 pb-8 font-medium text-center">-</td>
              <td className="pt-3 pb-6 font-medium text-right">
                {discount > 0 && "-"} ₹{discount.toFixed(2)}
                {discount > 0 && <p className="text-green-700 text-sm mt-1">Offer applied</p>}
              </td>
            </tr>
            <tr className="font-bold border-t border-b border-gray-200 text-gray-800 text-[14px]">
